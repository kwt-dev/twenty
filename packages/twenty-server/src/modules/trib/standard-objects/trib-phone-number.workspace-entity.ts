...
@WorkspaceEntity({
  ...
  labelSingular: msg`TRIB Phone Number`,
  labelPlural: msg`TRIB Phone Numbers`,
  description: msg`A phone number in the TRIB messaging system with provider capabilities`,
  icon: 'IconPhone',
  shortcut: 'P',
...
export class TribPhoneNumberWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceField({
    ...
    description: msg`Phone number in E.164 format (+1234567890)`,
    icon: 'IconPhone',
  })
  ...
  @WorkspaceField({
    ...
    label: msg`Type`,
    description: msg`Phone number type classification`,
    icon: 'IconCategory',
    options: [
      { value: TribPhoneNumberType.MOBILE, label: 'Mobile', color: 'blue', position: 0 },
      { value: TribPhoneNumberType.LANDLINE, label: 'Landline', color: 'gray', position: 1 },
      {
      ...
      { value: TribPhoneNumberType.VOIP, label: 'VoIP', color: 'orange', position: 4 },
    ],
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.SELECT,
    label: msg`Status`,
    description: msg`Phone number operational status`,
    icon: 'IconCheck',
    options: [
      { value: TribPhoneNumberStatus.ACTIVE, label: 'Active', color: 'green', position: 0 },
      {
      ...
      { value: TribPhoneNumberStatus.BLOCKED, label: 'Blocked', color: 'red', position: 5 },
    ],
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.TEXT,
    label: msg`Country Code`,
    description: msg`ISO 3166-1 alpha-2 country code (US, CA, etc.)`,
    icon: 'IconFlag',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.TEXT,
    label: msg`Carrier`,
    description: msg`Mobile carrier or service provider`,
    icon: 'IconNetwork',
  })
  @WorkspaceIsNullable()
  carrier: string | null;
  ...
  @WorkspaceField({
    ...
    label: msg`Capabilities`,
    description: msg`Supported messaging capabilities (SMS, MMS, Voice)`,
    icon: 'IconSettings',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.TEXT,
    label: msg`Region`,
    description: msg`Geographic region or area code`,
    icon: 'IconMap',
  })
  @WorkspaceIsNullable()
  region: string | null;
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.TEXT,
    label: msg`Timezone`,
    description: msg`Timezone identifier (America/New_York)`,
    icon: 'IconClock',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    description: msg`Formatted phone number for display (+1 (234) 567-8900)`,
    icon: 'IconEye',
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceField({
    ...
    label: msg`Validated`,
    description: msg`Whether phone number has been validated`,
    icon: 'IconCheck',
    defaultValue: false,
  })
  validated: boolean;
  ...
  @WorkspaceField({
    ...
    description: msg`Method used to verify phone number ownership`,
    icon: 'IconShield',
    options: [
      {
      ...
      { value: TribVerificationMethod.MANUAL, label: 'Manual', color: 'gray', position: 3 },
      {
  ...
  @WorkspaceField({
    ...
    type: FieldMetadataType.RAW_JSON,
    label: msg`Metadata`,
    description: msg`Provider-specific metadata and configuration`,
    icon: 'IconCode',
  })
  @WorkspaceIsNullable()
